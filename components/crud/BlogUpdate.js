        ...
        if (router.query.slug) {
            singleBlog(router.query.slug).then(data => {
                if (data.error) {
                    ...
                    setValues({  ...values, formData: new FormData(), title: data.title });//changed code for TypeError: formData.set is not a function
                    setBody(data.body);
            ...
            if (data.error) {
                ...
                //if (isAuth() && isAuth().role === 1) {
                    // Router.replace(`/admin/crud/${router.query.slug}`);
                      ...
                      //Router.push(`/blogs`);//new added
                      //setTimeout(() => { //new added
                        //Router.reload();//new added
                      //}, 500);//new added
