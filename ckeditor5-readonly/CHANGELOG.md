...
## [19.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v18.0.0...v19.0.0) (2020-04-29)
...
## [18.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v17.0.0...v18.0.0) (2020-03-19)
...
- Added the [Automatic text transformation](https://ckeditor.com/docs/ckeditor5/latest/features/text-transformation.html) feature to the build. See [ckeditor/ckeditor5#6304](https://github.com/ckeditor/ckeditor5/issues/6304). ([af021aa](https://github.com/ckeditor/ckeditor5-readonly/commit/af021aa))
...
## [17.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v16.0.0...v17.0.0) (2020-02-19)
...
## [16.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v15.0.0...v16.0.0) (2019-12-04)
...
- Replaced UglifyJS with Terser. See [ckeditor/ckeditor5#1353](https://github.com/ckeditor/ckeditor5/issues/1353). ([6d387bd](https://github.com/ckeditor/ckeditor5-readonly/commit/6d387bd))
...
## [15.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v12.4.0...v15.0.0) (2019-10-23)
...
Regarding the build itself, we added the [list indentation](https://ckeditor.com/docs/ckeditor5/latest/features/indent.html#indenting-lists) button to the build's default setup. See [ckeditor/ckeditor5#1844](https://github.com/ckeditor/ckeditor5/issues/1844). ([5dc1e87](https://github.com/ckeditor/ckeditor5-readonly/commit/5dc1e87))
...
## [12.4.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v12.3.1...v12.4.0) (2019-08-26)
...
- Bumped style-loader to v1.0.0. Aligned the webpack config to the new loader API. See [ckeditor/ckeditor5#1945](https://github.com/ckeditor/ckeditor5/issues/1945). ([9e69c1e](https://github.com/ckeditor/ckeditor5-readonly/commit/9e69c1e))
- The issue tracker for this package was moved to https://github.com/ckeditor/ckeditor5/issues. See [ckeditor/ckeditor5#1988](https://github.com/ckeditor/ckeditor5/issues/1988). ([8b4af5d](https://github.com/ckeditor/ckeditor5-readonly/commit/8b4af5d))

## [12.3.1](https://github.com/ckeditor/ckeditor5-readonly/compare/v12.3.0...v12.3.1) (2019-07-10)
...
## [12.3.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v12.2.0...v12.3.0) (2019-07-04)
...
## [12.2.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v12.1.0...v12.2.0) (2019-06-05)
...
## [12.1.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v12.0.0...v12.1.0) (2019-04-10)
...
## [12.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v11.2.0...v12.0.0) (2019-02-28)
...
## [11.2.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v11.1.1...v11.2.0) (2018-12-05)
...
## [11.1.1](https://github.com/ckeditor/ckeditor5-readonly/compare/v11.1.0...v11.1.1) (2018-10-11)

This releases fixes the README of this package on npm.

## [11.1.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v11.0.1...v11.1.0) (2018-10-08)
...
- Added the table and media embed features to the build. See [ckeditor/ckeditor5#1247](https://github.com/ckeditor/ckeditor5/issues/1247). ([01281a1](https://github.com/ckeditor/ckeditor5-readonly/commit/01281a1))

## [11.0.1](https://github.com/ckeditor/ckeditor5-readonly/compare/v11.0.0...v11.0.1) (2018-07-18)

Internal changes only (updated dependencies, documentation, etc.).

## [11.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v10.1.0...v11.0.0) (2018-07-18)
...
- Changed the structure of the build repository. Closes [ckeditor/ckeditor5#1038](https://github.com/ckeditor/ckeditor5/issues/1038). ([623c871](https://github.com/ckeditor/ckeditor5-readonly/commit/623c871))
- Updated `webpack` to version 4 (applies to custom builds only). ([9392b43](https://github.com/ckeditor/ckeditor5-readonly/commit/9392b43))
...
## [10.1.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v10.0.1...v10.1.0) (2018-06-21)
...
## [10.0.1](https://github.com/ckeditor/ckeditor5-readonly/compare/v10.0.0...v10.0.1) (2018-05-22)
...
## [10.0.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v1.0.0-beta.4...v10.0.0) (2018-04-25)
...
- Changed the license to GPL2+ only. See [ckeditor/ckeditor5#991](https://github.com/ckeditor/ckeditor5/issues/991). ([379c31f](https://github.com/ckeditor/ckeditor5-readonly/commit/379c31f))

### BREAKING CHANGES

- The license under which CKEditor 5 is released has been changed from a triple GPL, LGPL and MPL license to a GPL2+ only. See [ckeditor/ckeditor5#991](https://github.com/ckeditor/ckeditor5/issues/991) for more information.

## [1.0.0-beta.4](https://github.com/ckeditor/ckeditor5-readonly/compare/v1.0.0-beta.3...v1.0.0-beta.4) (2018-04-19)
...
## [1.0.0-beta.3](https://github.com/ckeditor/ckeditor5-readonly/compare/v1.0.0-beta.2...v1.0.0-beta.3) (2018-04-10)

### NOTE

This release followed `v1.0.0-beta.2` immediately to fix the issue mentioned below. Therefore, when upgrading from `v1.0.0-beta.1` make sure to also check [`v1.0.0-beta.2` release notes](https://github.com/ckeditor/ckeditor5-readonly/releases/tag/v1.0.0-beta.2).

### Bug fixes

- Translations should work when CKEditor was loaded using RequireJS. See [ckeditor/ckeditor5#914](https://github.com/ckeditor/ckeditor5/issues/914). ([16cba07](https://github.com/ckeditor/ckeditor5-readonly/commit/16cba07))

## [1.0.0-beta.2](https://github.com/ckeditor/ckeditor5-readonly/compare/v1.0.0-beta.1...v1.0.0-beta.2) (2018-04-10)
...
- Removed duplicated `ImageUpload` plugin. See [ckeditor/ckeditor5#909](https://github.com/ckeditor/ckeditor5/issues/909). ([8553d0f](https://github.com/ckeditor/ckeditor5-readonly/commit/8553d0f))

## [1.0.0-beta.1](https://github.com/ckeditor/ckeditor5-readonly/compare/v1.0.0-alpha.2...v1.0.0-beta.1) (2018-03-15)
...
- Added the image upload button to the build. See [ckeditor/ckeditor5#870](https://github.com/ckeditor/ckeditor5/issues/870). ([f6cab12](https://github.com/ckeditor/ckeditor5-readonly/commit/f6cab12))

### Other changes

- Aligned build and `webpack.config.js` to the new Translation Service ([ckeditor/ckeditor5#624](https://github.com/ckeditor/ckeditor5/issues/624)). ([a349ffb](https://github.com/ckeditor/ckeditor5-readonly/commit/a349ffb))
- Changed the webpack configuration so the styles are processed using PostCSS instead of SASS (see [ckeditor/ckeditor5-ui#144](https://github.com/ckeditor/ckeditor5-ui/issues/144)). ([040b92f](https://github.com/ckeditor/ckeditor5-readonly/commit/040b92f))

## [1.0.0-alpha.2](https://github.com/ckeditor/ckeditor5-readonly.git/compare/v1.0.0-alpha.1...v1.0.0-alpha.2) (2017-11-14)
...
- Build scripts will work on Windows. Closes [#26](https://github.com/ckeditor/ckeditor5-readonly/issues/26). ([6c980fd](https://github.com/ckeditor/ckeditor5-readonly/commit/6c980fd))

### Other changes

- Optimized the bundle size (~10%) by enabling webpack's `ModuleConcatenationPlugin` plugin. Read more https://github.com/ckeditor/ckeditor5/issues/475. ([d25def7](https://github.com/ckeditor/ckeditor5-readonly/commit/d25def7))

## [1.0.0-alpha.1](https://github.com/ckeditor/ckeditor5-readonly/compare/v0.4.0...v1.0.0-alpha.1) (2017-10-03)
...
- It will be possible to configure toolbar offset without overriding preconfigured toolbar items. See [ckeditor/ckeditor5#572](https://github.com/ckeditor/ckeditor5/issues/572). ([e7fbda9](https://github.com/ckeditor/ckeditor5-readonly/commit/e7fbda9))

### Features

Besides new features introduced in the dependencies, this build also introduces these features:

- Added Easy Image with Cloud Services and CKFinder adapter. See [ckeditor/ckeditor5#567](https://github.com/ckeditor/ckeditor5/issues/567). ([668691f](https://github.com/ckeditor/ckeditor5-readonly/commit/668691f))

## [0.4.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v0.3.0...v0.4.0) (2017-09-07)

### Other changes

- The build now defines the editor as its default export. This makes requiring the build easier when using AMD, CJS or ES6 modules. See [ckeditor/ckeditor5#545](https://github.com/ckeditor/ckeditor5/issues/545). ([e5c7511](https://github.com/ckeditor/ckeditor5-readonly/commit/e5c7511))
...
## [0.3.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v0.2.0...v0.3.0) (2017-09-03)

### Features

- Support for building the editor in another language than `en`. Closes [#11](https://github.com/ckeditor/ckeditor5-readonly/issues/11). ([f4233a5](https://github.com/ckeditor/ckeditor5-readonly/commit/f4233a5))

### Other changes

- Removed the compat-type of build. Closes [#20](https://github.com/ckeditor/ckeditor5-readonly/issues/20). ([529a319](https://github.com/ckeditor/ckeditor5-readonly/commit/529a319))

## [0.2.0](https://github.com/ckeditor/ckeditor5-readonly/compare/v0.1.1...v0.2.0) (2017-05-07)

### Bug fixes

- CSS should be minified. Closes [#7](https://github.com/ckeditor/ckeditor5-readonly/issues/7). ([ae2da32](https://github.com/ckeditor/ckeditor5-readonly/commit/ae2da32))

### Features

- Added the block quotes feature. Closes [#5](https://github.com/ckeditor/ckeditor5-readonly/issues/5). ([ab5db32](https://github.com/ckeditor/ckeditor5-readonly/commit/ab5db32))

### Other changes

- Changed the order of buttons in the image toolbar. See https://github.com/ckeditor/ckeditor5-image/issues/60. ([131cbe7](https://github.com/ckeditor/ckeditor5-readonly/commit/131cbe7))
- Use the essentials preset instead of low level features like typing and enter. Closes [#9](https://github.com/ckeditor/ckeditor5-readonly/issues/9). ([80314bf](https://github.com/ckeditor/ckeditor5-readonly/commit/80314bf))

## [0.1.1](https://github.com/ckeditor/ckeditor5-readonly/compare/v0.1.0...v0.1.1) (2017-04-06)

### Other

- Updated the bundles (the previous release contained an outdated bundles). ([0ac7b07](https://github.com/ckeditor/ckeditor5-readonly/commit/0ac7b07))

## 0.1.0 (2017-04-05)

### Features

- Initial implementation. Closes [#1](https://github.com/ckeditor/ckeditor5-readonly/issues/1). ([f88bc52](https://github.com/ckeditor/ckeditor5-readonly/commit/f88bc52))
